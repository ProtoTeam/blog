...
业界提供了一些库来解决这个问题，比如 [immutability-helper](https://github.com/kolodny/immutability-helper) 或者 [immutable](https://github.com/facebook/immutable-js)。前者是一个基于 Array 和 Object 操作的库，就一个文件但是使用起来很方便。例如上面的例子就可以写成下面这种：
...
相比于 immutability-helper， immutable 则要强大许多，但是与此同时，也增加了学习的成本，因为需要学习新的 API，由于没怎么用过，在此不再赘述，具体知识点可移步[这里](https://zhuanlan.zhihu.com/p/20295971)。最后推荐下另一个库[immutability-helper-x](https://github.com/ProtoTeam/immutability-helper-x)，API更好用哦~
